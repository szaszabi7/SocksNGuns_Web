            ...
            <div>
                ...
                <div :class="showEmailEdit ? 'block' : 'hidden'">
                    <div class="flex items-center mt-2">
                        <input id="email-address" type="email" name="email" v-model="user.email" @keyup.enter="changeEmail" placeholder="Email" class="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-pink-600">
                        <div>
